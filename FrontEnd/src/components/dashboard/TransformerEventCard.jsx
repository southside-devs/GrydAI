...
export default function TransformerEventCard({
  ...
  return (
    <div className="flex flex-col gap-2.5 w-60">
      ...
      <div className="bg-[#0b0e14] border border-[#f59e0b]/80 rounded-[28px] py-4 px-5 text-center flex flex-col items-center justify-center">
      ...
      <button
        onClick={onReport}
        type="button"
        className="w-full bg-[#ffe600] hover:bg-[#eab308] text-black font-bold text-xs py-3 px-4 rounded-full flex items-center justify-between transition-all duration-200 active:scale-[0.98] cursor-pointer"
      >
