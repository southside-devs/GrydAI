    ...
    <div className="flex-1 bg-[#0b0e14]/90 border border-white/[0.08] rounded-2xl p-5 flex flex-col justify-between backdrop-blur-md relative overflow-hidden group hover:border-[#ffe600]/30 transition-all duration-300">
      <div className="border-b border-white/[0.06] pb-3.5">
        ...
        <div className="flex items-center justify-between">
          <div className="w-10 h-10 rounded-xl bg-[#ffe600]/10 border border-[#ffe600]/25 flex items-center justify-center text-[#ffe600]">
            <Wallet size={20} />
          </div>
          <div className="text-right">
            <div className="flex items-baseline justify-end gap-1.5">
              ...
              <span className="text-sm font-mono text-[#64748b] font-medium">INR</span>
            </div>
      ...
      <div className="pt-3.5">
        <div className="flex items-center justify-between mb-2.5">
          ...
          <button className="text-[#64748b] hover:text-[#10b981] transition-colors cursor-pointer">
            <ArrowUpRight size={20} />
          </button>
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="text-right">
            <div className="flex items-baseline justify-end gap-1">
              ...
              <span className="text-sm font-mono text-[#64748b] font-medium">km</span>
            </div>
            <div className="text-xs font-mono text-[#64748b] mt-0.5">
